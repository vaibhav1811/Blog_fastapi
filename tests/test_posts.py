...
@pytest.mark.anyio #lets us run async tests function without needing to manage the event loop manually, as pytest-asyncio will automatically handle the event loop for us during testing.
